use crate::adapters::services::{ServicesPropertiesWindowUiAdapter, ServicesUiAdapter};
use crate::{
...
impl UiServiceDetailsPort for ServicesUiAdapter {
...
#[slint_port_adapter(window = AppWindow)]
impl UiServicesPort for ServicesUiAdapter {
