use app_contracts::features::processes::{ProcessCategory, ProcessRow};

pub(crate) const MEMORY_COMPRESSION: &str = "Memory Compression";
...
impl GroupsCache {
    ...
    pub(crate) fn get(&mut self, rows: &[ProcessRow], selected: Option<u32>) -> &[Section] {
